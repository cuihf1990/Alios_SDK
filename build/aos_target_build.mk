...
ifeq ($(COMPILER),armcc)
	$(eval LINK_OPTS := $(AOS_SDK_LINK_SCRIPT_CMD) $(call COMPILER_SPECIFIC_LINK_MAP,$(MAP_OUTPUT_FILE)) $(AOS_SDK_LDFLAGS) $(call COMPILER_SPECIFIC_LINK_FILES, $(AOS_SDK_LINK_FILES) $(filter %.a,$^) $(LINK_LIBS)) )
	$(QUIET)$(call WRITE_FILE_CREATE, $@ ,$(LINK_OPTS))
else
	$(eval LINK_OPTS := $(AOS_SDK_LINK_SCRIPT_CMD) $(call COMPILER_SPECIFIC_LINK_MAP,$(MAP_OUTPUT_FILE))  $(call COMPILER_SPECIFIC_LINK_FILES, $(AOS_SDK_LINK_FILES) $(filter %.a,$^) $(LINK_LIBS)) $(AOS_SDK_LDFLAGS) )
	$(QUIET)$(call WRITE_FILE_CREATE, $@ ,$(LINK_OPTS) )
endif
