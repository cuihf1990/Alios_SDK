...
$(LINK_OUTPUT_FILE): $(LINK_LIBS) $(AOS_SDK_LINK_SCRIPT) $(LINK_OPTS_FILE) $(LINT_DEPENDENCY) | $(EXTRA_PRE_LINK_TARGETS)
	...
	$(QUIET)$(LINKER) $(OPTIONS_IN_FILE_OPTION_PREFIX_DIRECT)$(OPTIONS_IN_FILE_OPTION)$(LINK_OPTS_FILE)$(OPTIONS_IN_FILE_OPTION_SUFFIX) $(COMPILER_SPECIFIC_STDOUT_REDIRECT) -o $@
