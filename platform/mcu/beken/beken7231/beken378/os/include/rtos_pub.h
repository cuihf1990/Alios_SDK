...
typedef mico_bool_t                 beken_bool_t;
typedef mico_time_t                 beken_time_t;    
typedef mico_utc_time_t             beken_utc_time_t; 
typedef mico_utc_time_ms_t          beken_utc_time_ms_t; 
typedef mico_event_flags_t          beken_event_flags_t;
typedef mico_semaphore_t            beken_semaphore_t;
typedef mico_mutex_t                beken_mutex_t;
typedef mico_thread_t               beken_thread_t;
typedef mico_queue_t                beken_queue_t;
typedef mico_event_t                beken_event_t; 
typedef mico_event_flags_wait_option_t beken_event_flags_wait_option_t; 
typedef mico_timer_t                   beken_timer_t;                   
