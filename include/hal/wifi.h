...
typedef struct
{
    ...
    void (*scan_adv_compeleted)(hal_wifi_module_t *m, hal_wifi_scan_result_t *result, void *arg);
    void (*para_chg)(hal_wifi_module_t *m, hal_wifi_ap_info_adv_t *ap_info, char *key, int key_len, void *arg);
