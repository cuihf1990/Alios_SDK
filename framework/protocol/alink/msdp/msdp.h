...
typedef int (*get_subdev_attr_cb)(const char *mac, char *value_buff, int buff_size);
typedef int (*set_subdev_attr_cb)(const char *mac, const char *value_buff);
typedef int (*get_dev_attr_cb)(const char *uuid, const char *attr_name, char **attr_value);
typedef int (*set_dev_attr_cb)(const char *uuid, const char *attr_name, const char *attr_value);
...
attr_hanler_ptr msdp_get_attr_handler(const device_helper_ptr helper, const char *name);

service_handler_ptr msdp_get_service_handler(const device_helper_ptr helper, const char *name);
