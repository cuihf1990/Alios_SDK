...
{
	MD5_CTX *ctx = (MD5_CTX *) os_malloc(sizeof(MD5_CTX));
	if (NULL == ctx) {
		return NULL;
	}
...
{
	SHA256_CTX *ctx = (SHA256_CTX *) os_malloc(sizeof(SHA256_CTX));
	if (NULL == ctx) {
		return NULL;
	}
...
{
	SHA384_CTX *ctx = (SHA384_CTX *) os_malloc(sizeof(SHA384_CTX));
	if (NULL == ctx) {
		return NULL;
	}
...
{
	SHA512_CTX *ctx = (SHA512_CTX *) os_malloc(sizeof(SHA512_CTX));
	if (NULL == ctx) {
		return NULL;
	}
