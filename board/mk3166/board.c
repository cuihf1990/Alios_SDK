...
void board_init(void)
{
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_2].partition_start_addr       = 0x1000;
    ...
    hal_partitions[HAL_PARTITION_OTA_TEMP].partition_start_addr          = 0x42000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_3].partition_start_addr       = 0x40000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_4].partition_start_addr       = 0x41000;
