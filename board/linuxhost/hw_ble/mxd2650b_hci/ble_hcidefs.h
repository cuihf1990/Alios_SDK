...
#define HCI_BLE_CON_REQ_REPLY               (0x0020 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_CON_REQ_NEGATIVE_REPLY                (0x0021 | HCI_GRP_BLE_CMDS)

#define HCI_BLE_INVALID       (0x0066 | HCI_GRP_BLE_CMDS)

//mxd cmds
#define HCI_GRP_MXD_CMDS                (0x18 << 10)
#define HCI_MXD_READ_REG          (0x0001 | HCI_GRP_MXD_CMDS)
#define HCI_MXD_WRITE_REG          (0x0002 | HCI_GRP_MXD_CMDS)
#define HCI_GRP_MXD_CMDS_LEN                22
/*
CMD STRUCT

HCI_MXD_READ_REG :
	|-----1B------|----1B-------|--------------------REG_CONUTER*2B--------------|
              REG_TYPE     REG_CONUTER(MAX,10)                    REG ADDR

HCI_MXD_WRITE_REG:
	|-----1B------|----1B-------|--------------------REG_CONUTER*2B--------------|
              REG_TYPE     REG_CONUTER                    REG VALUE

REG_TYPE: 0 RF, 1 MODEM
*/

#define HCI_BLE_RESET                   (0x0003 | (0x03 << 10))
...
#define HCIC_BLE_CONPARA_REPLY_CMD_SIZE                 14
#define HCIC_BLE_CONPARA_NEGATIVE_REPLY_CMD_SIZE                 3
