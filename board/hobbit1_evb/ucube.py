...
component.add_global_macro('MBEDTLS_AES_ROM_TABLES=1')

# component.set_aos_global_config('MODULE', 'HOBBIT1_2')
# component.set_aos_global_config('HOST_CHIP', 'hobbit1_2')
