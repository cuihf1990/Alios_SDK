...
void board_init(void)
{
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_1].partition_start_addr       = 0x08020000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_2].partition_start_addr       = 0x08021000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_4].partition_start_addr       = 0x08023000;
