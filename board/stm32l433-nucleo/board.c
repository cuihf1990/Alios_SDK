...
void board_init(void)
{
    ...
    hal_partitions[HAL_PARTITION_OTA_TEMP].partition_start_addr          = 0x08081000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_3].partition_start_addr       = 0x080FE000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_4].partition_start_addr       = 0x080FF000;
