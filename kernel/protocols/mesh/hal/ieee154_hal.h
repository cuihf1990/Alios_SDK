...
enum {
    ...
    IEEE154_DISCOVERY_RETRY_TIMES      = 2,
    IEEE154_ATTACH_REQUEST_TIMEOUT     = 1000,   /* ms */
    IEEE154_SID_REQUEST_TIMEOUT        = 3000,   /* ms */
    IEEE154_ATTACH_REQUEST_RETRY_TIMES = 2,
    IEEE154_ATTACH_SID_RETRY_TIMES     = 2,
    IEEE154_ATTACH_RETRY_TIMEOUT       = 180000, /* ms, 3 mins */
    IEEE154_ADVERTISEMENT_TIMEOUT      = 20000,  /* ms, 20 seconds */
    IEEE154_NEIGHBOR_ALIVE_TIMEOUT     = 120000, /* ms, 2  mins */
    IEEE154_NETWORK_ALIVE_TIMEOUT      = 300000, /* ms, 5  mins */
    IEEE154_MIGRATE_TIMEOUT            = 3,
    IEEE154_MIGRATE_WAIT_TIMEOUT       = 8 * IEEE154_ADVERTISEMENT_TIMEOUT,
    IEEE154_BECOME_LEADER_TIMEOUT      = 3,
