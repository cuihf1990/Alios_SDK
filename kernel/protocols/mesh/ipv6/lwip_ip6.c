...
static void ur_sock_read_cb(void *arg)
{
...
int echo_socket(raw_data_handler_t handler)
{
    ...
    yoc_poll_read_fd(g_echo.socket, ur_sock_read_cb, &g_echo);
...
int autotest_raw_socket(raw_data_handler_t handler)
{
    ...
    yoc_poll_read_fd(raw_autotest.socket, ur_sock_read_cb, &raw_autotest);
...
int autotest_udp_socket(raw_data_handler_t handler, uint16_t port)
{
    ...
    yoc_poll_read_fd(udp_autotest.socket, ur_sock_read_cb, &udp_autotest);
