...
static const unsigned short const crc16_table[256] = {
...
int dload_free_ram(void *base, uint32_t nbytes)
{
    free(base);
    return 0;
}

/* norflash fs interfaces stub */

/*stub fd as image base*/
#define FLASH_ADDR_START 0x10000000
